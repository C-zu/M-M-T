...
public class process extends javax.swing.JFrame {
    ...
    private void XemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_XemActionPerformed
        try {
            ...
            {
                String s0 = program.is.readLine();
                String s1 = program.is.readLine();
                String s2 = program.is.readLine();
                String s3 = program.is.readLine();
                String s4 = program.is.readLine();
                String s5 = program.is.readLine();
